...
Current UI assets are self-created for this repository:
...
- whether redistribution inside this repository is allowed.

Assets with unclear license terms should not be used.
